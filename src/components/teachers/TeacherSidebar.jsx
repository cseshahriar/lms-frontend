    ...
    return (
        <div className='card'>
            ...
            <div className='list-group list-group-flush'>
                ...
                <Link to='/teacher-favorite-courses' className='list-group-item list-group-item-action'>favorite Courses</Link>
                <Link to='/teacher-recommended-courses' className='list-group-item list-group-item-action'>Recommended Courses</Link>
